  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-base font-semibold text-gray-700 mb-2">Class Section</label>
          <input
            type="text"
            name="class_section"
        ...
        <div>
          <label className="block text-base font-semibold text-gray-700 mb-2">Hours Taught</label>
          <input
            type="number"
            name="hours_taught"
        ...
        <button
          type="submit"
          className="w-full px-4 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-base"
        >
          Submit
        </button>
      </form>
